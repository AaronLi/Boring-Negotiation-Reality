...
class Caster:
    def __init__(self, name, health, mana, attack_damage, caster_class, ability1, ability2, ability3, animation_handler,
                 story, **kwargs):
        self.name = name
        self.health = health
    ...
    def regen_mana(self):
        self.restore_mana(self.max_mana // 5.8)
    ...
    def __str__(self):
        ...
        self.name, self.health, self.max_health, self.mana, self.max_mana, self.attack_damage, self.caster_class,
        str(self.abilities))
